...
@src, @ui Ten kod działa poprawnie, ale chce go zoptymalizować, . Przeanalizuj go pod tym kątem i przygotuj zwarty raport.md z numerowanymu punktami co model AI ma zrobić by poprawić kod. Chce uniknąć over-engineeringu. Pokaż tylko pliki które potrzebuja poprawek. 
